...
public class Submit_Skill_Phase {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		submitSkillPhase(driver);
	}

	
	
	static void submitSkillPhase(WebDriver driver) throws InterruptedException, AWTException
	{
		
		
		/* For Skill Phase, Script is written on considering there should be two sections under Skill Phase.
		 * For the Skill phase if there are more then two sections then this script will only process with two sections. */
		
		String searchSkillPhase = "Skill01";
		String skillObservation = "Skill Observation to be submitted";
		...
		.sendKeys(searchSkillPhase);
		Thread.sleep(3000);

		String searchedSkillPhase = driver.findElement(By.className("media-heading")).getAttribute("title");
		// System.out.println(searchedWelcomePhase);

		String visibiltyOfSkillPhase = driver.findElement(By.className("mandatory-drop-link")).getText();
		// System.out.println(visibiltyOfWelcomePhase);

		String statusOfSkillPhase = driver.findElement(By.xpath(
		...
		if (searchedSkillPhase.contains(searchSkillPhase)
				&& visibiltyOfSkillPhase.equalsIgnoreCase("Yes")
				&& statusOfSkillPhase.equalsIgnoreCase("Not Started")) {
			driver.findElement(By.xpath(
			...
			//Working with First section of Skill Phase
			...
			StringSelection skillFirstEviFileLocation = new StringSelection("C:\\sikuliimg\\imgNews.jpg");
			Toolkit.getDefaultToolkit().getSystemClipboard().setContents(skillFirstEviFileLocation, null);
			...
			{
				System.out.println("Evidence uploaded Successfully and gets auto Approved for Skill Phase");
				
			}
			else
			{
				System.out.println("Evidence might not get uploaded corectly or the Auto Approve functionality for employer is not working for Skill.");
				
			}
			
			
			//Working with second section of Skill Phase
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("/html[1]/body[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/form[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]")).sendKeys(skillObservation);
			Thread.sleep(10000);
			...
			String skillPhaseStatusAfterSubmit = driver.findElement(By.xpath(
					"/html[1]/body[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[1]/span[2]"))
					.getText();
			
			String btnPresenseOnSkillAfterSave = driver
					.findElement(
							By.xpath("/html[1]/body[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/form[1]/span[1]/a[1]"))
					.getText();

			if (skillPhaseStatusAfterSubmit.equalsIgnoreCase("Submitted")
					&& btnPresenseOnSkillAfterSave.equalsIgnoreCase("Mark as Completed")) {
				System.out.println("Skill Phase submitted successfully");
			...
			System.out.println(
					" A Selected Skill phase may already submitted. We are Unable to submit this Phase. ----ERROR");
		}
	}
}